...
public class TaskController {
    ...
    public ResponseEntity<TaskDTO> cambiarEstado(@RequestParam Long idTask, @RequestParam String status){

        try {
            TaskDTO tareaDTO = this.iTaskService.cambiarEstado(idTask, status);
            if (tareaDTO == null){
